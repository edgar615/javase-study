...
public class AES {
    ...
    private static Key generateKey() throws Exception {
        Key key = new SecretKeySpec("ABCDEFGHIJKLMNOPABCDEFGHIJKLMNOP".getBytes(), KEY_ALGORITHM);
        return key;
    }
    ...
    static void method12(String str) throws Exception {
        byte[] encrypt = AESUtil.aesEncrypt("ABCDEFGHIJKLMNOPABCDEFGHIJKLMNOP", str);

        System.out.println("method1-加密：" + Arrays.toString(encrypt));
        String decrypt = AESUtil.aesDecrypt("ABCDEFGHIJKLMNOPABCDEFGHIJKLMNOP", encrypt);
        System.out.println("method1-解密后：" + decrypt);
