package com.edgar.vertx.spring.verticle;

import com.edgar.vertx.spring.service.ProductService;
...
public class SpringDemoVerticle extends AbstractVerticle {
    ...
    public SpringDemoVerticle(final ApplicationContext context) {
        service = (ProductService) context.getBean(ProductService.class);
    }
