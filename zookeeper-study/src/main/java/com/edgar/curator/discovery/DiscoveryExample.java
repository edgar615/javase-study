...
public class DiscoveryExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      serviceDiscovery =
              ServiceDiscoveryBuilder.builder(InstanceDetails.class).client(client).basePath(PATH)
  ...
  private static void listRandomInstance(String[] args,
    ...
    if (provider == null) {
      ...
      Thread.sleep(
              2500); // give the provider time to warm up - in a real application you wouldn't
              // need to do this
    }
  ...
  private static void printHelp() {
    System.out.println(
            "An example of using the ServiceDiscovery APIs. This example is driven by entering "
