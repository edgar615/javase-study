package com.edgar.curator.discovery;
 ...
 * Each individual
 * instance in your distributed set of applications would create an instance of something
 * similar to ExampleServer,
...
public class ExampleServer implements Closeable {
  ...
  public ExampleServer(CuratorFramework client, String path, String serviceName,
    ...
    // if you mark your payload class with @JsonRootName the provided JsonInstanceSerializer will
    // work
