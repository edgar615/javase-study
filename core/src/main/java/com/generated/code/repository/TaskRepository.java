...
import com.generated.code.repository.db.TaskDB;
 ...
 */
@Repository
public class TaskRepository extends JdbcRepository<Task, Integer>
{
	...
	{
		super (TaskDB.ROW_MAPPER, TaskDB.ROW_UNMAPPER);
	}
